...
import com.nighthawk.csa.algorithm.catalanModel.*;
...
public class CatalanController {
    ...
    public List<_Catalan> catInit(int nth) {
        //Fibonacci objects created with different initializers
        List<_Catalan> catList = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        List<_Catalan> catList = new CatalanController().catInit(nth);
        for (_Catalan catalan : catList)
